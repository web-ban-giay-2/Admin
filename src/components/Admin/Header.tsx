...
const Header = () => {
  const [adminId , adminName] = localStorage.getItem("user")?.split(",") || []
  useEffect(() => {
    console.log(adminId)
  })
  return (
        ...
        <nav className="navbar navbar-expand-lg navbar-light">
          ...
          <div className="navbar-collapse justify-content-end px-0" id="navbarNav">
            <ul className="navbar-nav flex-row ms-auto align-items-center justify-content-end">
              {/* <a href="https://adminmart.com/product/modernize-free-bootstrap-admin-dashboard/" target="_blank" className="btn btn-primary">
                Download Free
              </a> */}
